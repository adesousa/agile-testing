...
sudo mkdir selenium
sudo curl -O http://selenium-release.storage.googleapis.com/3.8/selenium-server-standalone-3.8.1.jar
sudo curl -O http://selenium-release.storage.googleapis.com/3.8/selenium-java-3.8.1.zip
...
sudo curl -O https://chromedriver.storage.googleapis.com/$version/chromedriver_mac64.zip
# if you cannot succeed in downloading the chromedriver above this line use this instead: sudo curl -O https://chromedriver.storage.googleapis.com/2.39/chromedriver_mac64.zip
